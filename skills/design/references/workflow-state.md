...
3. **Before dispatching a coder for a task**, the orchestrator checks `git log --oneline` for commits containing the Task ID. If found, the task is already done 鈥?skip it.
